...
export default function VideoDownloader({
  ...
  return (
    <div className="grid place-items-center h-screen">
      <div className="w-[95%] rounded-lg bg-white p-6 sm:w-[90%] md:w-[800px]">
        <h1 className="font-medium font-satoshi">{name} Video Downloader</h1>
        <div className="mt-2 space-y-12">
          <div id="form-container" className={downloadURL ? "hidden" : "block"}>
            <div className="flex flex-col gap-2 md:flex-row md:gap-6">
              ...
              <button
                ...
                disabled={isLoading}
                className="font-clash hover:bg-text-emerald-600 flex justify-center gap-3 rounded-lg bg-emerald-500 px-4 py-2 font-black text-white transition-all hover:gap-5 md:w-48 disabled:opacity-50"
              >
                <svg
                  width="22"
                  height="20"
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M12.7295 1.50847L12.9439 9.49381C13.329 9.50319 13.6665 9.5151 13.9614 9.52847C14.9224 9.57202 15.3139 10.4761 14.6712 11.1918C14.3942 11.5004 14.0578 11.8602 13.6514 12.2745C12.8193 13.1225 12.1831 13.6283 11.7427 13.9263C11.2832 14.2371 10.7165 14.237 10.257 13.9262C9.81666 13.6283 9.18044 13.1224 8.34832 12.2745C7.94159 11.8601 7.60505 11.5001 7.32797 11.1915C6.68543 10.4759 7.07689 9.57207 8.03759 9.52852C8.33286 9.5151 8.67061 9.50319 9.05619 9.49376L9.27042 1.50865C9.28729 0.880756 9.70739 0.33219 10.3324 0.269812C10.5353 0.249556 10.7604 0.236115 11.0001 0.236115C11.2399 0.236115 11.4648 0.249551 11.6677 0.269797C12.2926 0.332165 12.7127 0.880664 12.7295 1.50847Z"
                    fill="white"
                  />
                </svg>
