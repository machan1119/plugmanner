...
const SectionWhyChoose = memo(({ className = "" }: SectionWhyChooseProps) => {
  return (
    <section
      ...
      aria-label="Why Choose SocialPlug Section"
    >
      <div className="max-w-[1366px] justify-self-center px-4 sm:px-6 md:px-8 lg:px-10">
        ...
        <div
          className="flex flex-col lg:grid lg:[&>*:nth-child(3)]:col-span-2 2xl:[&>*:nth-child(3)]:col-span-1 lg:grid-cols-2 2xl:grid-cols-3 gap-4 sm:gap-6 md:gap-8 items-center"
          role="list"
