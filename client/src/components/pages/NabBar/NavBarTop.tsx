...
const NavBarTop = memo(() => {
  ...
  return (
    <div className="bg-black text-white text-xs md:text-sm flex relative justify-center overflow-hidden z-50">
      <div className="flex justify-center gap-0 md:gap-14 lg:gap-18 py-1">
