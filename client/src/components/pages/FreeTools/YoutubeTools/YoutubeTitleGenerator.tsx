...
export default function YoutubeTitleGenerator() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="bg-white p-9 md:p-10 rounded-2xl w-[90%] max-w-[535px]">
        <h1 className="font-satoshi font-medium text-[27.8px] mb-6 leading-tight">
          Get a new title for your video
        </h1>
          ...
          <div className="flex items-center justify-center gap-2 transition-all duration-300 hover:gap-6">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M6.53084 0.847651C8.44843 0.633909 10.4494 0.446426 12.5 0.446426C14.5506 0.446426 16.5516 0.633909 18.4691 0.847651C21.4548 1.18044 23.8537 3.57732 24.1737 6.56836C24.3779 8.47603 24.5536 10.4636 24.5536 12.5C24.5536 14.5363 24.3779 16.5239 24.1737 18.4316C23.8537 21.4227 21.4548 23.8196 18.4691 24.1523C16.5516 24.3661 14.5506 24.5536 12.5 24.5536C10.4494 24.5536 8.44843 24.3661 6.53084 24.1523C3.54521 23.8196 1.14626 21.4227 0.826255 18.4316C0.622155 16.5239 0.446426 14.5363 0.446426 12.5C0.446426 10.4636 0.622155 8.47603 0.826255 6.56836C1.14626 3.57732 3.54521 1.18044 6.53084 0.847651Z"
                fill="white"
              />
            </svg>
          </div>
        ...
        <div className="text-center mt-7">
          ...
          >
            <span className="underline">Check out other AI-powered tools</span>
            <span>→</span>
          </a>
        </div>
      </div>
