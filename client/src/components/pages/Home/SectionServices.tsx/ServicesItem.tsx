...
const ServicesItem = memo(({ serviceData }: ServicesItemProps) => {
  ...
  return (
    <div
      className="inline-block relative bg-black-light border-[1px] border-black-dark rounded-[12px] p-4 w-full h-max transition-all duration-300 hover:border-gray-600 hover:shadow-lg"
      tabIndex={0}
