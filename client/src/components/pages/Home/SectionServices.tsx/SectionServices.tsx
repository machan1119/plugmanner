...
const SectionServices = () => {
  ...
  return (
    <div className="flex flex-col items-center m-[5%] justify-self-center relative w-full px-[5%] max-w-[1366px]">
      ...
      <div className="flex items-end mb-5">
        ...
        <div className="absolute right-[5%] border-[1px] border-black-dark flex rounded-[10px]">
