...
const StatusItem = ({ count, type, time }: StatusType) => {
  return (
    <div className="flex justify-between font-satoshi text-base leading-6 px-4 py-3 bg-[rgb(215_249_235)] rounded-lg shadow-[rgb(187_229_218)_3px_4px_12px_0px_inset] h-[46px] overflow-hidden">
