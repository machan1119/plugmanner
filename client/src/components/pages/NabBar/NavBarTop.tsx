  ...
  return (
    <div className="bg-black text-white text-[10px] md:text-[14px] flex relative justify-center overflow-hidden px-[15%]">
      ...
      <Image
        ...
        className="hidden sm:flex w-[8%] absolute inset-[-20%_auto_auto_13%] lg:inset-[-90%_auto_auto_13%] lg:w-[125px]"
      />
      <Image
        width={110}
        height={110}
        ...
        className="hidden sm:flex w-[8%] absolute inset-[10%_13%_-25%_auto] lg:inset-[-30%_13%_-25%_auto] lg:w-[120px]"
      />
    </div>
  );
};
