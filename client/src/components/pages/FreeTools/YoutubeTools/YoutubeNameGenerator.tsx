  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="bg-white p-6 md:p-8 rounded-xl w-[90%] max-w-[535px]">
        <h1 className="font-satoshi font-medium text-2xl mb-5">
          Get a new Youtube name
        </h1>
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            maxLength={200}
            className="w-full min-h-[88px] p-2.5 text-lg border border-gray-300 rounded-md resize-y focus:outline-none focus:ring-2 focus:ring-emerald-500"
          />
        </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full -translate-y-2 p-3.5 bg-emerald-500 border-none rounded-lg cursor-pointer disabled:opacity-50"
        >
          <div className="flex items-center justify-center gap-2 transition-all duration-300 hover:gap-6">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M4.62372 0.439569C9.63015 0.180015 14.3698 0.180015 19.3762 0.439569C21.5272 0.551087 23.2955 2.21912 23.4617 4.39123C23.7254 7.8413 23.7254 11.1587 23.4617 14.6088C23.2955 16.7809 21.5272 18.4489 19.3762 18.5604C14.3698 18.82 9.63015 18.82 4.62372 18.5604C2.47273 18.4489 0.704395 16.7809 0.538307 14.6088C0.274504 11.1587 0.274502 7.8413 0.538307 4.39123C0.704393 2.21912 2.47273 0.551069 4.62372 0.439569Z"
                fill="white"
              />
            </svg>
            <span className="font-clash-display text-white text-2xl font-semibold">
              Generate Names
            </span>
          </div>
        </button>
