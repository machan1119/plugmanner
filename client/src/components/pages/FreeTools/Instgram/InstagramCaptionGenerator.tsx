  ...
  return (
    <section className="w-full py-6 md:py-14 lg:py-[64px] gap-6 md:gap-14 lg:gap-16 bg-white flex flex-col items-center bg-[linear-gradient(#fffffff5,#fff),url('https://cdn.prod.website-files.com/628d4467de238a5806753c9b/67bb4de67a2ea65794f385ee_perspective-grid-black.webp')] bg-[position:0_0,50%_0] bg-[size:auto,contain] bg-no-repeat">
      <div className="max-w-[1366px] w-full flex flex-col gap-4 items-center px-10">
        ...
        <div className="w-full max-w-3xl min-h-[410px] p-8 bg-white flex flex-col items-center gap-5 rounded-xl">
          <h1 className="w-full text-[21px] text-left text-[#686889]">
            Caption this image...
          </h1>
          <div className="flex flex-col md:flex-row gap-16 w-full">
            <div className="flex flex-col gap-6 w-[60%] relative">
              <div
                ...
                className="upload-area w-full h-[370px] flex flex-col items-center justify-center gap-3 border border-dashed border-gray-300 rounded-xl cursor-pointer"
              >
                <input
                  type="file"
                  ref={fileInputRef}
                ...
                {selectedFile ? (
                  ...
                  <>
                    ...
                    <div className="upload-text text-gray-600 text-center">
                      ...
                      <span className="text-primary">select one</span>
                    </div>
              ...
              <div className="text-gray-700">Description (optional)</div>
              <textarea
                value={description}
                onChange={(e) => setDescription(e.target.value)}
                className="w-full min-h-[88px] p-4 border border-gray-300 rounded-lg text-base resize-vertical"
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full mt-4 p-4 transition-all hover:gap-6 bg-primary text-white rounded-md text-xl font-clash font-semibold flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
            ...
            <div className="flex flex-col gap-2 w-[40%]">
              <div className="text-lg font-normal mb-2 text-gray-700">
                Variants
              </div>
              <div className="relative mb-5 w-[60%]" ref={dropdownRef}>
                <button
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                  className="w-full p-2 pl-4 bg-white border border-gray-300 text-gray-700 rounded-lg text-lg text-left flex justify-between items-center"
                >
                  {variations}
                </button>
                {isDropdownOpen && (
                  <div className="absolute top-full z-10 left-0 w-full bg-white rounded-lg shadow-md mt-2">
                    {[1, 3, 5].map((value) => (
                      <div
                        key={value}
                        onClick={() => {
                        ...
                        className={`dropdown-item p-4 text-lg cursor-pointer hover:bg-gray-100 ${
                          value === variations ? "bg-primary text-white" : ""
                        }`}
                      >
                        {value}
                      </div>
              ...
              <div className="flex justify-between items-center w-[60%]">
                <span className="text-lg text-gray-700 py-1">Add hashtags</span>
              ...
              <div className="flex justify-between items-center w-[60%]">
                <span className="text-lg text-gray-700 py-1">Add emojis</span>
                <label className="switch relative inline-block w-11 h-6">
                  <input
                    type="checkbox"
                    checked={addEmojis}
              ...
              <div className="mt-6">
                <div className="text-lg font-normal mb-6 text-gray-700">
                  Writing tone
                </div>
          ...
          {captions.length > 0 && (
            <div className="w-full flex gap-5 flex-col border-2 rounded-2xl border-primary mt-4">
