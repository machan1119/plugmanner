    ...
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="w-full max-w-4xl min-h-[410px] p-8 bg-white flex flex-col items-center gap-10 rounded-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          <h1 className="font-medium text-2xl col-span-2">AI Hook Generator</h1>
          ...
          <div className="flex flex-col gap-6 w-full relative">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xl font-normal mt-6">Content Goal:</label>
              <input
                value={goal}
            ...
            <div className="flex flex-col gap-2 mt-[20px] w-full md:block md:w-72 md:absolute md:translate-x-full md:left-1/2 -top-20">
              <label className="text-xl font-normal">Variants</label>
              <div className="relative w-full" ref={dropdownRef}>
                <button
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                  className="w-full p-4 bg-white border border-gray-300 rounded-lg text-lg text-left flex justify-between items-center"
                >
                  {variations}
                </button>
                {isDropdownOpen && (
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full mt-4 p-4 transition-all hover:gap-6 bg-emerald-500 text-white rounded-2xl text-2xl font-semibold flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
              <svg
                width="23"
                height="21"
        ...
        {hooks.length > 0 && (
          <div className="w-full flex gap-5 flex-col border-2 rounded-2xl border-emerald-500">
