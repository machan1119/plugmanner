...
const OurPartners = memo(() => {
  ...
  return (
    <section className="flex flex-col py-[20px] md:py-16 lg:py-[80px] items-center bg-black-medium w-full bg-cover bg-[url('https://cdn.prod.website-files.com/628d4467de238a5806753c9b/675716e51edb39c901338ea7_hero_background-pattern.webp')] bg-center bg-no-repeat overflow-hidden">
      <div className="mb-8 flex flex-col gap-3 items-center w-[100%] md:w-[50%]">
      ...
      <div className="grid grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4 md:gap-6 w-full md:w-[60%] max-w-7xl mx-auto">
